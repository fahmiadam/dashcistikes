...
<body id="page-top">
	...
	<div id="wrapper">
		...
		<div id="content-wrapper">
            ...
            <span><h1>Seluruh Data Mahasiswa </h1></span>
...
<ol class="breadcrumb"><button class="btn btn-link" type="button" data-toggle="collapse" data-target=".tahun" aria-expanded="false" aria-controls="tahun1 tahun2">
          Tahun</button></ol>

  <div class="row">
 <div class="col-lg-4">
<div class="collapse tahun" id="tahun1">
              <div class="card mb-3">
                <div class="card-header">
                  <i class="fas fa-chart-pie"></i>
                  Tahun</div>
  <!-- <div class="form-inline">   --> 
   <!-- <th> -->
      ...
      <div id="tahun" width="50%" height="50"></div>
      <script type="text/javascript">
...
<!-- <th> -->
 ...
 <div class="col-lg-8">
 <div class="collapse tahun" id="tahun2">
              <div class="card mb-3">
                <div class="card-header">
                  <i class="fas fa-chart-bar"></i>
                  Tahun</div>
<script src="highcharts/pie/highcharts.js"></script>
      <script src="highcharts/pie/exporting.js"></script>
      <script src="highcharts/pie/export-data.js"></script>
<div id="tahunn" width="50%" height="50"></div>
      <script type="text/javascript">

      Highcharts.chart('tahunn', {
        chart: {
            plotBackgroundColor: null,
            plotBorderWidth: null,
            plotShadow: false,
