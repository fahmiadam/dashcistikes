...
<div>
    <button class="btn btn-link btn-md text-white order-1 order-sm-0 mr-3 ml-1" id="sidebarToggle" href="#">
        <i class="fas fa-bars"></i>
    </button>
</div>
    <a class="navbar-brand mr-1" href="<?php echo site_url('home') ?>"><img src="<?php echo base_url('assets/img/stikes.png')?>"  height="50" alt=""><b>STIKES</b> BETHESDA</a>
  ...
  <!--   <form class="navbar-nav ml-auto ml-md-6">
    <ul class="navbar-nav"> -->
